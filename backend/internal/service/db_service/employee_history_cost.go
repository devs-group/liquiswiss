...
func (s *DatabaseService) ListEmployeeHistoryCosts(userID int64, historyID string, page int64, limit int64) ([]models.EmployeeHistoryCost, int64, error) {
...
func (s *DatabaseService) GetEmployeeHistoryCost(userID int64, historyCostID string) (*models.EmployeeHistoryCost, error) {
	var employeeHistoryCost models.EmployeeHistoryCost
	var labelID sql.NullInt64
	var labelName sql.NullString
...
func (s *DatabaseService) CreateEmployeeHistoryCost(payload models.CreateEmployeeHistoryCost, userID int64, historyID string) (int64, error) {
...
func (s *DatabaseService) UpdateEmployeeHistoryCost(payload models.CreateEmployeeHistoryCost, userID int64, historyCostID string) error {
...
func (s *DatabaseService) CopyEmployeeHistoryCosts(payload models.CopyEmployeeHistoryCosts, userID int64, historyID string) error {
