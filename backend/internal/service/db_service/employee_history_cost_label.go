...
func (s *DatabaseService) GetEmployeeHistoryCostLabel(userID int64, historyCostLabelID string) (*models.EmployeeHistoryCostLabel, error) {
...
func (s *DatabaseService) UpdateEmployeeHistoryCostLabel(payload models.CreateEmployeeHistoryCostLabel, userID int64, historyCostLabelID string) error {
