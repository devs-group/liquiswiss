...
func (s *DatabaseService) ListSalaryCostLabels(userID int64, page int64, limit int64) ([]models.SalaryCostLabel, int64, error) {
...
func (s *DatabaseService) GetSalaryCostLabel(userID int64, salaryCostLabelID int64) (*models.SalaryCostLabel, error) {
	var salaryCostLabel models.SalaryCostLabel
	...
	err = s.db.QueryRow(string(query), salaryCostLabelID, userID).Scan(
		&salaryCostLabel.ID,
		&salaryCostLabel.Name,
	)
	if err != nil {
...
func (s *DatabaseService) CreateSalaryCostLabel(payload models.CreateSalaryCostLabel, userID int64) (int64, error) {
...
func (s *DatabaseService) UpdateSalaryCostLabel(payload models.CreateSalaryCostLabel, userID int64, salaryCostLabelID int64) error {
...
func (s *DatabaseService) DeleteSalaryCostLabel(salaryCostLabelID int64, userID int64) error {
