...
func (m *MockIDatabaseService) CreateEmployeeHistory(payload models.CreateEmployeeHistory, userID, employeeID int64) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDatabaseService) UpdateEmployeeHistory(payload models.UpdateEmployeeHistory, employeeID, historyID int64) error {
	m.ctrl.T.Helper()
