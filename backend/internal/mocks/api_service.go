...
func (m *MockIAPIService) ListScenarios(userID, page, limit int64) ([]models.Scenario, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIAPIServiceMockRecorder) ListScenarios(userID, page, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListScenarios", reflect.TypeOf((*MockIAPIService)(nil).ListScenarios), userID, page, limit)
}
