...
BEGIN
    ...
    IF target_date IS NULL THEN
        -- If target_date is NULL, calculate based on history's from_date
        IF curr_date < from_date THEN
            -- curr_date is before history starts
            RETURN 0;
        ELSE
    ...
    span_loop: WHILE span_start < span_end DO
        ...
        CASE amount_type
            ...
            WHEN 'percentage' THEN
                SET full_cost = full_cost + (salary * amount / 100);
            END CASE;
