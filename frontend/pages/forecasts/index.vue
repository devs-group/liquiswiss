    ...
    <div class="flex flex-col overflow-x-auto p-4">
      <div class="grid grid-cols-12 items-center">
        <div class="flex items-center col-span-full">
          ...
          <div v-for="month in months" class="border-t border-b border-l last:border-r border-gray-600 bg-gray-300 p-2 min-w-32">
        ...
        <div class="flex items-center col-span-full">
          ...
          <div v-for="revenue in revenues" class="border-b border-l last:border-r border-gray-600 bg-green-100 p-2 min-w-32">
        ...
        <div class="flex items-center col-span-full">
          ...
          <div v-for="expense in expenses" class="border-b border-l last:border-r border-gray-600 bg-red-100 p-2 min-w-32">
            <p class="text-xs text-center">
        ...
        <div class="flex items-center col-span-full">
          ...
          <div v-for="cashflow in cashflows" class="border-b border-l last:border-r border-gray-600 p-2 min-w-32"
        ...
        <div class="flex items-center col-span-full">
          ...
          <div v-for="saldo in saldos" class="border-b border-l last:border-r border-gray-600 p-2 min-w-32"
...
const {listForecasts, limitForecasts, forecasts} = useForecasts()
...
const revenues = computed(() => forecasts.value.map(f => ({
  amount: f.revenue,
  formatted: NumberToFormattedCurrency(AmountToFloat(f.revenue), 'de-CH'),
})))
const expenses = computed(() => forecasts.value.map(f => ({
  amount: f.expense,
  formatted: NumberToFormattedCurrency(AmountToFloat(f.expense), 'de-CH'),
})))
const cashflows = computed(() => forecasts.value.map(f => ({
  amount: f.cashflow,
